...
ap.add_argument("--tree-random-init", action="store_true",
                help="usa el brazo arreglado del NODE; por omision se usa el "
                     "publicado, con los parametros de arbol en cero")
...
OVERRIDES = {"tree_random_init": True} if a.tree_random_init else None
...
print(f"[rejilla] ipc={a.ipc} p={P} | embedder={a.embedder} (brazo {brazo}) | "
    ...
    for s in range(a.seeds):
        ...
        for ver, mod in VERSIONES:
            ...
            fila = dict(version=ver, dataset=ds, tipo=tipo, C=C, d=d,
                        embedder=a.embedder, brazo=brazo, ipc=a.ipc, p=P,
