...
def tame_critic_synthesize(data, config):
    ...
    # Cronometro por iteracion, con el bloque del critico como fase aparte; ver
    # synth/instrument.py. Con n_critic pasos de critico por cada paso
    # sintetico, separarlos dice cual de las dos mitades cuesta.
    ...
    for it in range(iters + 1):
        ...
        timer.mark("critic", it)       # aqui termina el bloque del critico
